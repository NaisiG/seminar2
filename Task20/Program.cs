...
// которая принимает на вход координаты двух точеки 
// находит рассояние между ними в 2D пространстве.
// А (3,6); B (2,1) -> 5,09
// А (7,-5); B (1,-1) -> 7,21
...
Console.WriteLine($"Distanse beten segments with coordinats {xa}, {xb} and {ya}, {yb} is {OurDistance}");
